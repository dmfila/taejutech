jQuery(document).ready(function () {
  LoginForm.initLoginForm(), ContactForm.initContactForm();

  $('.grid').isotope({
    itemSelector: '.grid > .col-sm-6',
...
// ksh check start // check the homepage is https and check it is the trusted url
        ...
        // ! function(t, a, e, i, l, n, s) {
//     t.GoogleAnalyticsObject = l, t[l] = t[l] || function() {
//         (t[l].q = t[l].q || []).push(arguments)
//     }, t[l].l = 1 * new Date, n = a.createElement(e), s = a.getElementsByTagName(e)[0], n.async = 1, n.src = i, s.parentNode.insertBefore(n, s)
// }(window, document, "script", "https://www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-76680743-1", "auto"), ga("send", "pageview"), 
